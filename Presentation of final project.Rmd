...
- Decentralization and devolution have been at the center of national policy for the past decade, as a mechanism for poverty alleviation 
...
##Model 1: Impact of decentralization on water access
...
R3wateredu.out <- setx(R3water, educ_adult = seq(8, 86, by = 10))
...
#log pop or population?

R3sonebpop.out <- setx(R3soneb, population = seq(10, 13, by = 0.5))
...
R3pubhosppop.out <- setx(R3pubhosp, population = seq(10, 13, by = 0.5))
