...
```{r, echo=FALSE, results='asis'}
labels <- c('Decentralization', 'Population', 'Population Density', 'Log Public Expenditure per capita', 'Log Consumption per Capita', 'Average Households Health Consumption Ratio', 'Average Literacy Rate of Head of Households', 'Monetary Poverty Index','ind_pauv_mon', 'gini','for_dentr.','(Intercept)')
