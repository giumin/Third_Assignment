...
The second dataset is taken from the WHO databases, particularly from the Global Health Obervatory Data Repository. What we want is the dataset that refers to the density of health infrastructures per 100000 population, including:
