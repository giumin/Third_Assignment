...
plot(Benin$SH.XPD.PCAP, type="o", col="brown", Benin$Year, xlab="total expenditure per capita on health", ylab="years")
title(main="Trend during the years", col.main="Black", font.main=4)
```
...
```{r}
infrastructures <- read.csv("/var/folders/ln/gccsc1ts04d6l8_0qk_rlhp00000gn/T//RtmphC4lgc/data1b454d0b21")
