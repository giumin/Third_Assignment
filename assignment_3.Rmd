...
summary(R2water)
R2water <- lm(pop_wateraccess ~ decentralization + population + Density + pubexp.c + Year, data = decenthealth)
summary(R2water)
...
R2soneb <- lm(connect_soneb ~ decentralization + population + Density + Year + consump.c, data = decenthealth)
summary(R2soneb)
