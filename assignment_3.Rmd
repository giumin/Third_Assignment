...
summary(R2soneb)
R3soneb <- lm(connect_soneb ~ decentralization + population + Density + population + Density + log(pubexp.c) + log(consump.c) + cons_health + educ_adult + ind_pauv_mon, data=decenthealth)
summary(R3soneb)
```
