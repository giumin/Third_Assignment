...
- Legal provisions has transfered large part of health provision competencies to subnational entities 
...
Decentralization: Authors's calculation, based on data from Municipal Financial Accounts of Benin's municipalitiess (Revenues & expenditures)

Deependant & Explanatory variables: Integrated Modular Survey on Households Living Conditions (EMICoV)
...
plot(simR3sonebpop, xlab = 'Log Population', ylab = 'Water Facilities')
...
plot(simR3pubhosppop, xlab = 'Population', ylab = 'Access to Healthcare Facilities')
```
