...
Unlike previous models, decentralizattion appears to be significant in our second restricted models. ike previous models, the results does not indicate any effect of decentralization on provision of water facilities. In order terms, giving more financial and administrative powers to municipal governments does not seem to increase the number of households that are connected to water pipeline, which indicates a lack of investment in that area. In our second restricted model, 
