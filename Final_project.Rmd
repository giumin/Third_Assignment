...
looks at the microeconomic effect of decentralization on basic health-related facilities. For this purpose, we compute an indicator for decentralization
...
The second part , and we use health-related indicators provided in Benin's Integrated Modular Households Survey (EMICoV). 
