...
It's worth noting that the adjusted R square has significantly increased in comparision with the previous equation, signaling an improvement in the goodness fit of the model. However, as we test for the global 
...
diagnosticpuphsp<-summary(gvmodelpubhosp)
