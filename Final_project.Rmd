...
In this model, we evaluate the impact of decentralization on access to water at the municipal level in Benin. As described in the econometric equation, decentralization is the independet variable, percentage of households in the municipality that have access to water. 
