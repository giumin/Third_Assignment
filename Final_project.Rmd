...
ggplot(data=Benin,aes(x=Year,y=Public.Health.Expenditure)) + geom_line() + geom_point() +theme_bw(base_size=14) + ggtitle("Trend of total public expenditure over the years\n")
