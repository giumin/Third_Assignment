...
ggplot(data=total,aes(x=Year,y=Public.Health.Expenditure)) + geom_line() + geom_point() +theme_bw(base_size=14) + ggtitle("Trend of total public expenditure over the years\n")

ggplot(data=total, aes(x=Year,y=Health.Expenditure.Per.Capita)) + geom_line() + geom_point() + theme_bw(base_size = 14) + ggtitle("Trend over the years\n")

ggplot(data=total, aes(x=Year,y=Improved.Sanitation.Facilities)) +geom_line() + geom_point() + theme_bw(base_size = 14) + ggtitle("Trend over the years\n")
