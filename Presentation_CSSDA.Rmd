...
library("arm")
data("combineddata.data", package = "car")
coefplot(R2water, xlim=c(-20, 80),            intercept=TRUE)
coefplot(R1water, add=TRUE, col.pts="red",  intercept=TRUE)
coefplot(R3water, add=TRUE, col.pts="blue", intercept=TRUE, offset=0.2)
```
...
stargazer::stargazer(R1water, R2water, R3water, covariate.labels = labels,
                     ...
                     digits = 2, type = 'html',font.size="tiny", header = FALSE)
```
