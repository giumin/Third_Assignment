...
$$ D = \alpha + \beta_{1}Decentralization + \beta_{2}Log Population + \beta_{3}Density + \beta_{4}Log Public Expenditures + \beta_{5}Log Comsumption per Capita + \beta_{6}Education + \beta_{7}PovertyIndex + \beta_{8}Gini Coefficient + \beta_{9}Perception on Decentralization + e $$
